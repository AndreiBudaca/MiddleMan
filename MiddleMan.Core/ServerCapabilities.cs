namespace MiddleMan.Core
{
  public static class ServerCapabilities
  {
    ...
    public static readonly int MaxMemoryBufferSize = int.TryParse(Environment.GetEnvironmentVariable("MIDDLEMAN_MAX_MEMORY_BUFFER_SIZE"), out int maxMemoryBufferSize) ? maxMemoryBufferSize : 2;
